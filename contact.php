...
<body>
  ...
  <script>
  //   const numbers = [34, 40, 56, 21];
  //   const newArr = numbers.map(myNumber);
  ...
  const square = [4, 5, 6, 7];
  const newSquare = square.map(mySquare);

  console.log(newSquare);
  document.getElementById("demo").innerHTML = newSquare;

  function mySquare(squareNumber) {
